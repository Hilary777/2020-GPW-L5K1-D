	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="ind.php" class="nav-link">Booking</a></li>
    		...
    		<div class="row">
    			<div class="col-md-4">
    				<div class="intro ftco-animate">
    					...
    					<p>Established in February 1956, chengdu bus company is a backbone passenger transport enterprise in chengdu.</p>
    				</div>
    			</div>
    			<div class="col-md-4">
    				<div class="intro ftco-animate">
    					<h3><span>02</span> Services provided</h3>
    					<p>Site query - provide bus line Numbers for all stops at the query site;
Line query -- provide the names of all stops on the line;
Transfer query - provides the query starting point to the end of the bus scheme.</p>
    				</div>
    			</div>
    			<div class="col-md-4">
    				<div class="intro ftco-animate">
    					<h3><span>03</span> spirit</h3>
    					<p>It is a major people's livelihood project, which is related to the people.</p>
    				</div>
    			</div>
    		</div>
    	</div>
