...
<html lang="en">
  <head>
    ...
    <title>Ticket booking theme</title>
            ...
            <div class="col-sm-7 right-wrapper">
            	<div class="event-ticket-wrapper">
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#buyTicket" aria-controls="buyTicket" role="tab" data-toggle="tab">Buy Tickets 1</a></li>
                    <li role="presentation"><a href="ticket.php" aria-controls="tickrt.php" role="tab" data-toggle="tab">Buy Tickets 2</a></li>
